...
A Python web scraper that scrapes game data from the LemonAmiga website (https://www.lemonamiga.com/games/list.php) and creates a JSON database.
...
- **`lemonamiga_db.json`**: The main database file containing all scraped game data
...
{
  "game-slug": {
    "url": "https://www.lemonamiga.com/game/game-slug",
    "gameid": 1366,
    ...
    "rating": 3.815,
    "nbvote": 8,
    "boxfront": "https://www.lemonamiga.com/uploads/amiga/images/games/covers/large/turrican_01.jpg",
    "boxback": "https://www.lemonamiga.com/uploads/amiga/images/games/covers/large/turrican_02.jpg",
    "titleshot": "https://www.lemonamiga.com/uploads/amiga/images/games/screens/eddie_edwards_super_ski/eddie_edwards_super_ski_01.png",
    "screenshot": "https://www.lemonamiga.com/uploads/amiga/images/games/screens/eddie_edwards_super_ski/eddie_edwards_super_ski_02.png",
    "youtubeurl": "https://www.youtube.com/watch?v=w-I35HbPJdM"
  }
}
```
...
- **gameid**: Unique game ID from LemonAmiga
- **name**: Game name
- **developer**: Developer name
- **genre**: Main genre (extracted from category, e.g., "Adventure" from "Adventure - Graphics/Text")
